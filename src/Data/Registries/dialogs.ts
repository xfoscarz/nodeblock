...
const dialogs: Record<string, Dialog> = {
    custom_options: {
        ...
        external_title: { translate: "menu.custom_options" },
        title: { translate: "menu.custom_options.title" }
    },
    quick_actions: {
        type: "minecraft:dialog_list",
        button_width: 310,
        ...
        exit_action: { label: { translate: "gui.back" }, width: 200 },
        external_title: { translate: "menu.quick_actions" },
    ...
    server_links: {
        ...
        columns: 1,
        exit_action: { label: { translate: "gui.back" }, width: 200 },
        external_title: { translate: "menu.server_links" },
        title: { translate: "menu.server_links.title" }
    }
};
