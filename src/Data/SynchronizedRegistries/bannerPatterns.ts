...
const bannerPatterns: Record<string, BannerPattern> = {
    ...
    "stripe_bottom": {
        asset_id: "stripe_bottom",
        translation_key: "block.minecraft.stripe_bottom"
    },
    "stripe_top": {
        asset_id: "stripe_top",
